{if !empty($popular_ycategs.top)}
	<div class="b-section b-section--alt">
		...
		<div class="b-section__content">
			<div class="container">
				<div class="row">
					{foreach $popular_ycategs.top as $entry}
						<div class="col-md-4">
							<div class="b-card b-card--1"{if $entry.category_image} style="background-image: url('{$smarty.const.IA_CLEAR_URL}uploads/{$entry.category_image.path}');"{/if}>
								<div class="b-card__content">
									...
									<div class="b-card__tags">
										{if isset($popular_ycategs.children[$entry.id])}
											{foreach $popular_ycategs.children[$entry.id] as $subEntry}
