<div class="ia-item">
    ...
    <div class="ia-item__content">
        <div class="ia-item__actions">
            {printFavorites item=$listing itemtype='member' guests=true tpl='no-text'}
            {accountActions item=$listing itemtype='member'}
        ...
        <div class="ia-item__additional">
            ...
            {if !empty($listing.website)}
                <p><span class="fa fa-globe"></span> <a href="{$listing.website|escape}" target="_blank">{lang key='field_member_website'}</a></p>
            {/if}
            {if !empty($listing.facebook)}
                <p><span class="fa fa-facebook"></span> <a href="{$listing.facebook|escape}" target="_blank">{lang key='field_member_facebook'}</a></p>
            {/if}
            {if !empty($listing.twitter)}
                <p><span class="fa fa-twitter"></span> <a href="{$listing.twitter|escape}" target="_blank">{lang key='field_member_twitter'}</a></p>
            {/if}
            {if !empty($listing.gplus)}
                <p><span class="fa fa-google-plus"></span> <a href="{$listing.gplus|escape}" target="_blank">{lang key='field_member_gplus'}</a></p>
            {/if}
            {if !empty($listing.linkedin)}
                <p><span class="fa fa-linkedin"></span> <a href="{$listing.linkedin|escape}" target="_blank">{lang key='field_member_linkedin'}</a></p>
            {/if}
        </div>
