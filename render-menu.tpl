...
{elseif 'footer_nav' == $position}
	{ia_menu menus=$menu.contents class="list-inline {$menu.classname}"}
{elseif 'account' == $position}
	...
	{else}
		<ul class="nav navbar-nav navbar-right nav-account">
			{*<li class="hidden-xs"><a href="{$smarty.const.IA_URL}favorites/"><span class="fa fa-star text-warning"></span> {lang key='wishlist'}</a></li>*}
			<li><a data-toggle="modal" data-target="#loginModal" href="#" class="" title="{lang key='login_sign_up'}"><span class="fa fa-user"></span></a></li>
		</ul>
